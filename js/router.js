...
const ROUTES = {
  ...
  "#/hoy": { kind: "hub", tab: "hoy", render: (data) => Screens.hoy(data) },
  "#/plan": { kind: "hub", tab: "plan", render: (data) => Screens.plan(data) },
  ...
  "#/practica/turno": { kind: "detail", back: "#/practica", title: "Simulación de Turno", render: (data) => Screens.turno(data) },

  "#/audio/lecciones": { kind: "detail", back: "#/audio", title: "Audio Lecciones", render: (data) => Screens.lecciones(data) },
